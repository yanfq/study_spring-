...
public class AmqpConf {
    ...
    @Bean
    public RabbitTemplate myExchangeTemplate(CachingConnectionFactory connectionFactory) {
    ...
    @Bean
    public RabbitTemplate myExchangeTemplate2(CachingConnectionFactory connectionFactory) {
        RabbitTemplate rabbitTemplate = new RabbitTemplate(connectionFactory);
        rabbitTemplate.setExchange("yanfq.topic");
        rabbitTemplate.setRoutingKey("yanfq.abc.123");
        return rabbitTemplate;
